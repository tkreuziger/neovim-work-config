...
vim.keymap.set({ "n", "x" }, "<leader>cref", function()
...
vim.keymap.set({ "n", "x" }, "<leader>crev", function()
	return refactor("Extract Variable")
end, { desc = "Variable", expr = true })
vim.keymap.set({ "n", "x" }, "<leader>creb", function()
...
vim.keymap.set({ "n", "x" }, "<leader>crif", function()
	return refactor("Inline Function")
end, { desc = "Function", expr = true })
vim.keymap.set({ "n", "x" }, "<leader>criv", function()
...
-- Neotest
keymap("n", "<leader>ct", ":Neotest summary toggle<cr>", get_opts("Show tests"))
